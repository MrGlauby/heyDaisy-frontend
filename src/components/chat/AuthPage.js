  ...
  return (
    ...
    <div className = "flex justify-center rounded-md max-w-400 m-4 my-24">
      <form onSubmit={onSubmit} className="">
        <div className="m-5 text-2xl">Be brave and start chatting with likeminded learners around the world!</div>
        <br></br>
        <div className="m-5 flex text-2xl items-center justify-center">Set a username to get started</div>
